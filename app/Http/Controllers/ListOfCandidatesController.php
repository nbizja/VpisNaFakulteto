...
class ListOfCandidatesController extends Controller
{
    ...
    public function getList(Request $request)
    {
        ...
        $kandidati = Uporabnik::where('vloga', '=', VlogaUporabnika::KANDIDAT)
            ...
            })->get(array('uporabnik.emso as id', 'uporabnik.ime as ime', 'uporabnik.priimek as priimek', 'visokosolski_zavod.ime as zavod', 'studijski_program.ime as program', 'studijski_program.nacin_studija as nacin'));
