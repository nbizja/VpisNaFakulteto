...
@section('content')
    <div class="container">
        <h4>Uvoz podatkov o poklicni maturi</h4>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
						{{ Form::open(array('action' => 'Matura\PoklicnaMaturaController@naloziDatoteko', 'files' => true)) }}
							...
							<div class="form-group">
								<label for="datotekaMaturant">Datoteka poklmat.txt</label>
								{{ Form::file('datotekaMaturant') }}
								<p class="help-block">Izberite datoteko s podatki o kandidatu in o splošnem uspehu.</p>
							</div>
							
							<div class="form-group">
								<label for="datotekaMaturantPre">Datoteka poklpre.txt</label>
